...
class MatchesNavBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        iconImageView.tintColor = #colorLiteral(red: 0.1530086398, green: 0.06894914061, blue: 0.203415215, alpha: 1)
        let messagesLabel = UILabel(text: "Messages", font: .boldSystemFont(ofSize: 20), textColor: #colorLiteral(red: 0.1530086398, green: 0.06894914061, blue: 0.203415215, alpha: 1), textAlignment: .center)
